...
const Contact = () => {
  ...
  return (
    <section id="contact" className='relative w-full h-[40rem] sm:h-full bg-gradient-to-b from-indigo-50 to-lime-200 flex flex-col sm:justify-center gap-8'>
      <div className='absolute self-center bottom-5 z-10 text-[10px] sm:text-xs px-4 py-1 bg-indigo-300 rounded-3xl border-zinc-900 border-2 border-b-4 text-zinc-800 flex gap-2'>
      ...
      <div className='h-[90%] flex flex-col justify-evenly items-center'>
        ...
        <ContactForm/>
        <ul className='flex bg-slate-00 justify-evenly w-40 z-10'>
