        ...
        <PageLayout>
          <div className='p-2 w-full lg:w-3/5 flex flex-col items-start'>
              ...
              <div className='mt-8 flex flex-col gap-6'>
                <p>
                  I&#39;m a senior majoring in Computer Science at <a target="_blank" href="https://gvsu.edu" className='font-medium  hover:font-semibold'>Grand Valley State University</a>.<br/><br/>
                ...
                <ul className='lg:w-4/5 grid grid-cols-2 sm:grid-cols-5 gap-1 sm:gap-2 gap-x-2 sm:gap-x-4'>
                  {skills.map((skill, index) => { return (
                    <li key={index} className='low-opacity-text-box text-[8px] sm:text-xs'>{skill}</li>
                  )})}
                </ul>
              </div>
            </div>
