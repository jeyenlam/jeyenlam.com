...
const IntroText = () => {
  return (
    <div className='items-baseline text-right border-r-4 sm:border-r-8 px-4 sm:px-6 bg-indigo-400 p-1 sm:p-4 border-2 border-zinc-900 rounded-xl text-zinc-900'>
    <motion.h1 
