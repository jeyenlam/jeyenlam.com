  ...
  return (
    <div className='text-zinc-900'>
      <ul className='text-base lg:text-2xl pt-4 flex gap-2 items-center justify-evenly w-28 lg:w-40'>
          ...
          <Link target="_blank" href='/YenLamResume2024v3.pdf' download={"YenLamResume2024v3.pdf"} className='flex relative group rounded-lg hover:bg-indigo-600 hover:text-inidgo-200 hover:translate-y-[2px] p-2 hover:text-indigo-200 bg-indigo-400'>
