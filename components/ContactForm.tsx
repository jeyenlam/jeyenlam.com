...
const ContactForm = () => {
  ...
  return (
    <form 
      ...
      className='sm:w-96 lg:w-[40rem] p-4 text-indigo-400 text-xs sm:text-sm border border-indigo-400 flex flex-col rounded-2xl gap-3 -b-2 lg:-b-4 justify-evenly'
    >
